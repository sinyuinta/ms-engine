...
${normalizedNotes.map(
    ...
    if (method === "GET" && path2 === "/persona/teamState") {
      ...
      return addEngineHeaders(res, method, path2, rawPath);
    }
    if (method === "POST" && path2 === "/persona/teamState") {
      ...
      const updated = { ...current, ...body.data, updatedAt: (/* @__PURE__ */ new Date()).toISOString() };
      await env.TEAM_STATE.put(team, JSON.stringify(updated));
      const h2 = withCors(new Headers(), origin);
      return addEngineHeaders(json({ ok: true, team, updated }, 200, h2), method, path2, rawPath);
    }
...
// .wrangler/tmp/bundle-aakDRy/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-aakDRy/middleware-loader.entry.ts
