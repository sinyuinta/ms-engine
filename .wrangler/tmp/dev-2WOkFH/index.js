...
var TARGETS = ["analyze", "summarize", "rewrite", "translate", "classify", "extract", "keywords", "outline", "chat", "rescue"];
var nowISO = /* @__PURE__ */ __name(() => (/* @__PURE__ */ new Date()).toISOString(), "nowISO");
var pick = /* @__PURE__ */ __name((o, keys) => {
  for (const k of keys) {
    const v = o?.[k];
...
__name(text, "text");
async function extractInput(req, url) {
  const q = url.searchParams.get("q");
  if (q) return { text: q, source: "query" };
  const ct = (req.headers.get("content-type") || "").toLowerCase();
  if (ct.includes("application/json")) {
    const raw = await req.text();
    try {
      const j = JSON.parse(raw);
      const v = pick(j, ["text", "input", "q", "prompt", "message"]);
      if (v) return { text: v, source: "json" };
    } catch {
  ...
  if (ct.includes("application/x-www-form-urlencoded")) {
    ...
    try {
      if (raw.includes("=")) {
        ...
        const v = sp.get("text") ?? sp.get("input") ?? sp.get("q") ?? sp.get("prompt") ?? sp.get("message") ?? "";
        if (v) return { text: v, source: "form" };
      }
    } catch {
    }
    return { text: raw, source: "text" };
  }
  return { text: await req.text(), source: "text" };
}
...
var src_default = {
  async fetch(req, env) {
    ...
    if ((method === "GET" || method === "POST") && path2 === "/persona/targets") {
      const h2 = withCors(new Headers(), origin);
      return addEngineHeaders(json(TARGETS, 200, h2), method, "/persona/targets", rawPath);
    }
          ...
          messages: [
            {
              ...
              content: `
\u3042\u306A\u305F\u306F\u6559\u80B2\u652F\u63F4AI\u3067\u3059\u3002
\u4EE5\u4E0B\u306E\u30ED\u30B0\u3092\u300C\u65AD\u5B9A\u300D\u300C\u56E0\u679C\u304C\u7C97\u3044\u300D\u300C\u6A29\u5A01\u306B\u4F9D\u5B58\u300D\u300C\u4EEE\u8AAC\u904E\u591A\u300D\u300C\u502B\u7406\u30EA\u30B9\u30AF\u300D\u306E\u89B3\u70B9\u3067\u6279\u5224\u7684\u306B\u8A55\u4FA1\u3057\u3066\u304F\u3060\u3055\u3044\u3002
...
`
        ...
        const h2 = withCors(new Headers(), origin);
        return addEngineHeaders(json({ results: parsed }, 200, h2), method, path2, rawPath);
      } catch (err) {
        const h2 = withCors(new Headers(), origin);
        return addEngineHeaders(
          json({ error: "openai_failed", message: String(err) }, 500, h2),
          ...
          messages: [
            {
              ...
              content: `
\u3042\u306A\u305F\u306F\u6559\u80B2\u652F\u63F4AI\u3067\u3059\u3002
\u4E0E\u3048\u3089\u308C\u305F\u8B70\u8AD6\u5185\u5BB9\u306B\u5BFE\u3057\u3066\u300C\u9069\u5207\u3060\u3068\u601D\u30464\u3064\u306E\u8996\u70B9\u300D\u3092\u81EA\u5206\u3067\u9078\u3073\u51FA\u3057\u3001
\u5404\u8996\u70B9\u3054\u3068\u306B\u300C\u76F2\u70B9\u300D\u3068\u300C\u6539\u5584\u306E\u52A9\u8A00\u300D\u3092\u793A\u3057\u3066\u304F\u3060\u3055\u3044\u3002

\u5FC5\u305A JSON \u914D\u5217\u3067\u8FD4\u3057\u3066\u304F\u3060\u3055\u3044\u3002
\u5404\u8981\u7D20\u306F\u6B21\u306E\u5F62\u5F0F\uFF1A
{
  "view": "\u8996\u70B9\u306E\u540D\u524D",
  "blindspot": "\u305D\u306E\u8996\u70B9\u304B\u3089\u898B\u305F\u76F2\u70B9",
  "advice": "\u6539\u5584\u306E\u305F\u3081\u306E\u77ED\u3044\u30A2\u30C9\u30D0\u30A4\u30B9"
}

\u6761\u4EF6:
- \u8996\u70B9\u306F\u8B70\u8AD6\u306B\u95A2\u9023\u6027\u304C\u9AD8\u3044\u3082\u306E\u3092\u81EA\u7531\u306B\u9078\u3093\u3067\u304F\u3060\u3055\u3044\u3002
- \u6570\u306F\u5FC5\u305A4\u3064\u3002
- \u51FA\u529B\u306FJSON\u306E\u307F\u3001\u6587\u7AE0\u306F\u4E0D\u8981\u3002
`
            },
...
`
    ...
    if (method === "POST" && path2 === "/persona/arrangeBoard") {
      const body = await req.json();
      const topic = body.topic || "";
      const spec = body.spec || "impact-feasibility";
          ...
          messages: [
            {
              role: "system",
              content: `
\u3042\u306A\u305F\u306F\u300C\u8B70\u8AD6\u30D5\u30A1\u30B7\u30EA\u30C6\u30FC\u30BF\u30FCAI\u300D\u3067\u3059\u3002
\u4EE5\u4E0B\u306E\u60C5\u5831\uFF08\u8B70\u984C\u3001\u30C1\u30FC\u30E0\u540D\u3001\u30E1\u30F3\u30D0\u30FC\u306E\u610F\u898B\u3084\u30CE\u30FC\u30C8\u5185\u5BB9\uFF09\u3092\u3059\u3079\u3066\u8003\u616E\u3057\u3066\u3001
\u3088\u308A\u826F\u3044\u89E3\u6C7A\u3084\u8B70\u8AD6\u306E\u9032\u5C55\u306B\u3064\u306A\u304C\u308B **\u63D0\u6848\u3084\u30D2\u30F3\u30C8** \u3092\u51FA\u3057\u3066\u304F\u3060\u3055\u3044\u3002
...
\u5404\u30D2\u30F3\u30C8\u306F\uFF1A
- \u300C\u3082\u3063\u3068\u3053\u3046\u8003\u3048\u305F\u3089\u3044\u3044\u304B\u3082\u300D\u300C\u3053\u3046\u3044\u3046\u89B3\u70B9\u304B\u3089\u898B\u76F4\u305D\u3046\u300D\u300C\u3053\u3046\u884C\u52D5\u3059\u308B\u306E\u306F\u3069\u3046\uFF1F\u300D\u306A\u3069\u306E\u5F62\u3067\u5177\u4F53\u7684\u306B\u3002
- 3\u301C5\u500B\u3002
          `
            },
            {
...
\u30C1\u30FC\u30E0\u540D: ${teamName}
\u30CE\u30FC\u30C8\u4E00\u89A7:
${notes.map((n) => `\u30FB${n.title || n.text || "(\u7121\u984C)"}\uFF08${n.author || "\u533F\u540D"}\uFF09`).join("\n")}
          `
            }
          ]
        });
        ...
        const h2 = withCors(new Headers(), origin);
        return addEngineHeaders(
          new Response(text2, { status: 200, headers: h2 }),
          method,
          path2,
          rawPath
        );
    ...
    if ((method === "GET" || method === "POST") && path2.startsWith("/persona/") && path2 !== "/persona/targets") {
      const target = path2.split("/")[2];
      if (!target || !TARGETS.includes(target)) {
        const h3 = withCors(new Headers(), origin);
        return addEngineHeaders(json({ error: "unknown_target", target }, 400, h3), method, path2, rawPath);
      }
      const inp = await extractInput(req, url);
      const h2 = withCors(new Headers(), origin);
      const body = { received: (inp.text || "").length, echo: inp.text, source: inp.source, target, now: nowISO() };
      return addEngineHeaders(json(body, 200, h2), method, `/persona/${target}`, rawPath, target);
    }
...
// .wrangler/tmp/bundle-RkDwBf/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-RkDwBf/middleware-loader.entry.ts
